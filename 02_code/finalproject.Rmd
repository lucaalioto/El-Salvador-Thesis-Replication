...
# Load the data
LAPOP <- haven::read_dta("finalproject/01_data/SLV_2021_LAPOP.dta") # Public Opinion data from 2021
clean_merged = read_rds("finalproject/01_data/clean-merged.rds") # election data from 2021
violence = read_csv("finalproject/01_data/ACLED Data_2025-11-20.csv")

LAPOP_2019 = haven::read_dta("data/ElSalvador LAPOP AmericasBarometer 2018 v1.0_W.dta") # Public Opinion data from 2019


# agrreggated / cleaned data
clean_merged = read_rds("finalproject/01_data/clean-merged-with-votes.rds")
...
ggplot(data = mydata2, aes(x = vicbar4a, y = bukele_perception_dummy)) +
